        ...
        <div>
            ...
            <CardForm NameForm={handleSubmit} Processing={processing} Inputs={
                <div className="row">
                    ...
                    <Input col="col-6" type="text" label="Orden" name="fuente" errors={errors.name} value={data.name} onChange={e => setData('name', e.target.value)}/>
                    ...
                    <Input col="col-6" type="text" label="Color" name="fuente" errors={errors.name} value={data.name} onChange={e => setData('name', e.target.value)}/>
                </div>
            }/>
        </div>
    );
