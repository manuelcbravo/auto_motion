...
// ----------------------------------------------------------------------------------------> DataPage
    const { RouteTrace, RouteNew, RouteEdit, DataTableHeader, DATA, id } = usePage().props;
    ...
    const dataTableBody = DATA.data.map(({ id, nombres, apellidos, email, rol, status, empresa}) => {
        return (
            <tr key={id}>
...
// ----------------------------------------------------------------------------------------> Render Page
    return (
        // Module Title
        <div>
            <TitleHeader Title={Title} Route={RouteTrace} RouteNewId={route(RouteNew, id)}/>
